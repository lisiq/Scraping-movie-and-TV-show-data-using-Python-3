...
# Load the data
df_tbsmovies =pd.read_csv('/home/lisi/MediaBiz/Second scrape/TBSmovies/tbsmovies.csv')
df_tntdramamovies= pd.read_csv('/home/lisi/MediaBiz/Second scrape/TNTDRAMAmovies/tntdramamovies.csv')
df_tbsshows= pd.read_csv('/home/lisi/MediaBiz/Second scrape/TBS/tbsshows.csv')
df_tntdramashows= pd.read_csv('/home/lisi/MediaBiz/Second scrape/TNTDRAMA/tntdramashows.csv')
df_trutvshows= pd.read_csv('/home/lisi/MediaBiz/Second scrape/TRUTV/trutvshows.csv')
df_nba= pd.read_csv('/home/lisi/MediaBiz/Second scrape/TNTDRAMA/tntdramanba.csv')
...
merged_df['capture_date'] = pd.Series([pd.to_datetime('05/08/2020')] * merged_df.shape[0]).dt.strftime('%m/%d/%Y') # adding the date that the data got scraped
...
merged_df.to_csv('/home/lisi/MediaBiz/Second scrape/finalproduct.csv', index=False)
