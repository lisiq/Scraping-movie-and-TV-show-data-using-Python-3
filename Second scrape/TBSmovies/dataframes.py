...
with open('/home/lisi/MediaBiz/Second scrape/TBSmovies/results.txt', 'r') as file:
...
tbsmovies_ldjson = pd.DataFrame(flat_list, columns=['url', 'language', 'bot_country', 
...
tbsmovies_drupla_settings_json = pd.DataFrame(flat_list)[to_keep]
...
df_tbsmovies.set_axis(['maturity_rating', 'program_title', 'url', 
